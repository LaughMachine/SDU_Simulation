...
fil = open(os.getcwd() + "/SimResults_B_C_" + str(sys.argv[1]) + ".csv","wb")
...
def main():
	...
	for k in krange:
		...
		row = []
		AR, BaR, BuR, EWT, PrC, PrS, PoC, PoS, EtoC, EtoS, aql, SS, ArrC, CArr, SCArr = simulation(1001000, 1000,  x, (20-x)*3 + 11, k, .65, .07, .07, .07, .07, 2.5, 2.5*1.5, 1.2, 1.2*1.5, 1.5, 9, 9, 1, 1)
		row.append(x)
